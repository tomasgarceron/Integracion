...
namespace Data
{
    public static class ProductoData
    {
        public static List<Producto> listaProducto = new List<Producto>{
            ...
            new Producto { Id=4 , NombreProducto= "Producto4", CategoriaId= 1, MarcaId= 1, Precio=2000, Costo=1400},
            new Producto { Id=5 , NombreProducto= "Producto5", CategoriaId= 1, MarcaId= 1, Precio=2450, Costo=1500},
        };
    }
}